...
public:
    MOCK_METHOD(int, getReputation, (const Creature &left, const Creature &right), (const override));
    MOCK_METHOD(int, getReputation, (Faction left, Faction right), (const override));
