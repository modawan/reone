 ...
 *
 * Commandline:
 *    --api='gl:core=4.0' --extensions='GL_EXT_texture_compression_s3tc,GL_EXT_texture_filter_anisotropic' c
 *
 * Online:
 *    http://glad.sh/#api=gl%3Acore%3D4.0&extensions=GL_EXT_texture_compression_s3tc%2CGL_EXT_texture_filter_anisotropic&generator=c&options=
 *
 */
