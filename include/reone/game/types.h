...
enum class VisualEffectType {
    ...
    ImpHealingSmall = 1001,
    ImpForceJumpAdvanced = 1002,
    ProAfflict = 1003,
    ImpChoke = 1004,
    ImpCure = 1005,
    ProDeathField = 1006,
    ProDroidDisable = 1007,
    ProDroidKill = 1008,
    ProDrain = 1009,
    ProForceArmor = 1010,
    ProForceAura = 1011,
    ...
    ProForceShield = 1015,
    ImpForceWave = 1017,
    ImpForceWhirlwind = 1018,
    ImpHeal = 1019,
    ImpSpeedKnight = 1020,
    ProLightningL = 1021,
    ImpSpeedMastery = 1022,
    ProResistElements = 1025,
    ProResistForce = 1026,
    ProResistPoison = 1027,
    ProLightningS = 1028,
    ImpMindForce = 1031,
    ImpSuppressForce = 1032,
    ImpMindKinight = 1033,
    ImpMindMastery = 1034,
    ProLightningJedi = 1035,
    ProLightningLSound = 1036,
    ImpGrenadeAdhesivePersonal = 1038,
    ImpFlame = 1039,
    ImpStun = 1040,

    DurStealthPulse = 2000,
    DurInvisibility = 2001,
    DurSpeed = 2004,
    DurForceWhirlwind = 2007,
    DurHold = 2008,
    DurBodyFual = 2024,
    DurPsychicStatic = 2025,
    BeamDeathFieldTentacle = 2026,
    BeamDroidDisable = 2027,
    BeamDroidDestroy = 2028,
    BeamDrainLife = 2029,
    DurKnightsSpeed = 2031,
    DurShieldRedMarkI = 2032,
    DurShieldRedMarkIi = 2034,
    DurShieldRedMarkIv = 2035,
    BeamLightningDarkS = 2037,
    BeamLightningDarkL = 2038,
    DurShieldBlue01 = 2040,
    DurShieldBlue02 = 2041,
    DurShieldBlue03 = 2042,
    DurShieldBlue04 = 2043,
    DurShieldGreen01 = 2044,
    DurShieldRed01 = 2045,
    DurShieldRed02 = 2046,
    DurShieldChrome01 = 2047,
    DurShieldChrome02 = 2048,
    BeamIonRay01 = 2049,
    BeamIonRay02 = 2050,
    BeamColdRay = 2051,
    BeamStunRay = 2052,
    BeamFlameSpray = 2053,
    DurCarboniteEncasing = 2054,
    DurCarboniteChunks = 2055,
    DurShieldBlueMarkI = 2056,
    DurShieldBlueMarkIi = 2058,
    DurShieldBlueMarkIv = 2059,

    FnfForceWave = 3001,
    FnfPlotManSonicWave = 3002,
    FnfGrenadeFragmentation = 3003,
    FnfGrenadeStun = 3004,
    FnfGrenadeThermalDetonator = 3005,
    FnfGrenadePoison = 3006,
    FnfGrenadeSonic = 3007,
    FnfGrenadeAdhesive = 3008,
    FnfGrenadeCryoban = 3009,
    FnfGrenadePlasma = 3010,
    FnfGrenadeIon = 3011,
    FnfGravityGenerator = 3013,

    ComSparksLarge = 4003,
    ComSparksLightsaber = 4004,
    ComSparksParryMetal = 4011,
    ComPowerAttackImprovedStaff = 4012,
    ComPowerBlastImproved = 4013,
    ComCriticalStrikeImprovedStaff = 4014,
    ComSniperShotImproved = 4015,
    ComMultiShot = 4016,
    ComWhirlwindStrikeStaff = 4017,
    ComCriticalStrikeMasteryStaff = 4018,
    ComPowerAttackMasteryStaff = 4019,
    ComSniperShotMastery = 4020,
    ComFlurryImprovedStaff = 4021,
    ComRapidShotImproved = 4022,
    ComBlasterDeflection = 4023,
    ComBlasterImpact = 4024,
    ComCriticalStrikeImprovedSaber = 4025,
    ComCriticalStrikeMasterySaber = 4026,
    ComPowerAttackImprovedSaber = 4027,
    ComPowerAttackMasterySaber = 4028,
    ComPowerBlastMastery = 4029,
    ComFlurryImprovedSaber = 4030,
    ComWhirlwindStrikeSaber = 4031,
    ComBlasterImpactGround = 4032,
    ComSparksBlaster = 4033,
    ComDroidExplosion1 = 4034,
    ComDroidExplosion2 = 4035,
    ComJediForceFizzle = 4036,
    ComForceResisted = 4037,

    ArdLightYellow10 = 5000,
    ArdLightYellow20 = 5001,
    ArdLightBlind = 5002,
    ArdHeatShimmer = 5003,
